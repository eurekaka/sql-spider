...
var FuncInfos = map[string]FuncInfo{
	...
	FuncTimeDiff:      {FuncTimeDiff, 2, 2, []TypeMask{TypeTime}, TypeTime, nil},
	FuncTimestampDiff: {FuncTimestampDiff, 3, 3, []TypeMask{TypeTime}, TypeTime, nil},
